  ...
  try {
    ...
    const client = await pgrestAdmin<any>('/clients', {
      ...
      body: {
        ...
        contact_person_2_name: body.contactPerson2Name || '',
        contact_person_2_surname: body.contactPerson2Surname || '',
        contact_person_2_email: body.contactPerson2Email || '',
        contact_person_2_mobile: body.contactPerson2Mobile || '',
        contact_person_2_landline: body.contactPerson2Landline || '',
